...
int gcd(int a1, int b1) { //НОД по алгоритму Евклида
    if (b1 == 0) return a1;
    return gcd(b1, a1 % b1);
}
...
matrix& operator=(const matrix& max){
    for(int i = n - 1; i>=0; i--){
     ...
     n=max.n;
     m=max.m;
     arr = new ration*[max.n];
    for (int i = 0; i < max.n; i++){
        arr[i] = new ration[max.m];
    }
...
void MNK(){
    ...
    case 1:{
        ...
        if(xy_size>=x_s){
            ...
            for(int i=0; i<k.n-2; i++){
                if(k.arr[k.n-i-2][0].a/k.arr[k.n-i-2][0].b>=0){
                    cout<<round(k.arr[k.n-i-1][0].a/k.arr[k.n-i-1][0].b*1000)/1000<<"*x^"<<k.n-i-1<<"+";
                }
                else{
                    cout<<round(k.arr[k.n-i-1][0].a/k.arr[k.n-i-1][0].b*1000)/1000<<"*x^"<<k.n-i-1;
                }
            ...
            if(k.arr[0][0].a/k.arr[0][0].b>=0){
                cout<<round(k.arr[1][0].a/k.arr[1][0].b*1000)/1000<<"*x+"<<round(k.arr[0][0].a/k.arr[0][0].b*1000)/1000<<endl;
            }
            else{
                cout<<round(k.arr[1][0].a/k.arr[1][0].b*1000)/1000<<"*x"<<round(k.arr[0][0].a/k.arr[0][0].b*1000)/1000<<endl;
            }
    ...
    case 2:{
        ...
        if(xy_size>=x_s){
            ...
            cout<<ar[k.n-1]<<")=";
            for(int i=0; i<k.n-2; i++){
                if(k.arr[i+1][0].a/k.arr[i+1][0].b>=0){
                    cout<<round(k.arr[i][0].a/k.arr[i][0].b*1000)/1000<<"*"<<ar[i]<<"+";
                }
                else{
                    cout<<round(k.arr[i][0].a/k.arr[i][0].b*1000)/1000<<"*"<<ar[i];
                }
            ...
            if(k.n>1){
                if(k.arr[k.n-1][0].a/k.arr[k.n-1][0].b>=0){
                    cout<<round(k.arr[k.n-2][0].a/k.arr[k.n-2][0].b*1000)/1000<<"*"<<ar[k.n-2]<<"+"<<round(k.arr[k.n-1][0].a/k.arr[k.n-1][0].b*1000)/1000<<"*"<<ar[k.n-1]<<endl;
                }
                else{
                    cout<<round(k.arr[k.n-2][0].a/k.arr[k.n-2][0].b*1000)/1000<<"*"<<ar[k.n-2]<<round(k.arr[k.n-1][0].a/k.arr[k.n-1][0].b*1000)/1000<<"*"<<ar[k.n-1]<<endl;
                }
                ...
                cout<<round(k.arr[k.n-1][0].a/k.arr[k.n-1][0].b*1000)/1000<<"*"<<ar[k.n-1]<<endl;
            }
    ...
    for(int jj=0; jj<yy.n; jj++){
        SS_tot=SS_tot+pow(y_cp.a/y_cp.b-y_i.arr[jj][0].a/y_i.arr[jj][0].b, 2);
    }

    double R2, R2_abj;
    R2=1-SS_res.a/SS_res.b/SS_tot.a*SS_tot.b;
